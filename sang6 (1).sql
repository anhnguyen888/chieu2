...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 18, 2024 lúc 06:50 AM
...
(5, 'Xe Mercedes Benz E class E300 AMG 2019 ', 'Mercedes_E300_AMG xanh cavansite nt nâu - Sản xuất 2019 - Odo: 49.000 km (Full lịch sử hãng) - Option: Loa Bumester, cửa sổ trời, rèm che nắng, LED nội thất, cốp điện, Auto Hold, phanh tay điện tử, lẫy chuyển số vô lăng, ga tự động Cruise Control, giới hạn tốc độ Lim,… - Bank 70% - trả trước từ 500tr', 999, 'uploads/m_1709473019.509.jpg'),
(6, 'Xe Honda CRV L 2024', 'Những điểm nổi bật trên Honda CR-V mới: - Công nghệ hỗ trợ lái xe an toàn tiên tiến Honda SENSING - Camera quan sát làn đường - Sạc không dây tiện ích - Cốp điện với tính năng mở cốp rảnh tay - Camera lùi 3 góc quay - Gạt mưa tự động,', 888, 'uploads/m_1709175548.745.jpg');
